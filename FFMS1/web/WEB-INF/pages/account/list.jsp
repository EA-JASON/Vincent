  ...
  <script>
    $(function () {
      ...
      $("a[name=delete]").click(function () {
        if($("input[id='acc']").is(':checked')==true){
          ...
          location.href="${pageContext.request.contextPath}/deleteaccounts?ids="+strIds;
          strIds = [];
        }else {
          alert("请至少选中一条记录!");
        }
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <table width="98%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <c:forEach items="${page.getResult()}" var="acc">
      <tr align="center">
        <td height="35"><input type="checkbox" class="ck" id="acc" name="checkbox" value="${acc.id}"></td>
        <td>收入</td>
      ...
      条&nbsp;&nbsp;第${page.getPageNum()}/${page.getPages()}&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/accountlist?pageNum=${page.getPages()-page.getPageNum()}">首页 |</a></a> <a href="${pageContext.request.contextPath}/accountlist?pageNum=${page.getPageNum()-1}" class="tex04">上一页</a> | <a name="nextpage" href="${pageContext.request.contextPath}/accountlist?pageNum=${page.getPageNum()+1}" class="tex04">下一页</a><a href="${pageContext.request.contextPath}/accountlist?pageNum=${page.getPages()}">| 末页</a>
